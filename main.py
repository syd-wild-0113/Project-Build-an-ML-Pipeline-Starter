    ...
    with tempfile.TemporaryDirectory() as tmp_dir:
        ...
        if "basic_cleaning" in active_steps:
            _ = mlflow.run(
                ...
                parameters={
                    ...
                    "output_description": "A cleaned sample with price outliers removed and missing values imputed",
        ...
        if "train_random_forest" in active_steps:
            ...
            _ = mlflow.run(
                ...
                parameters={
                    ...
                    "output_artifact": "random_forest_model.csv"
                }
            )
        ...
        if "test_regression_model" in active_steps:
            ...
            _ = mlflow.run(
                ...
                "main",
                parameters={
                    "mlflow_model": "random_forest_model.csv:prod",
                    "test_dataset": "test_clean_split.csv:latest"
                }
            )
